...
terms_pheno <- tibble(x = c(
           ...
           "phenoData|contact_email|xxxxx|TBdata_meta_char",
           "phenoData|contact_name|corr_author|TBdata_meta_char",
           "phenoData|disease_state|xxxxx|TBdata_clin_char",
           "phenoData|extract_protocol|xxxxxx|TBdata_meta_char",
           "phenoData|group|infection_disease_stage|TBdata_clin_char",
           "phenoData|instrument_model|sequencing_platform|TBdata_clin_char",
           "phenoData|library_strategy|xxxxx|TBdata_meta_char",
           "phenoData|mgit|xxxxxx|TBdata_clin_char",
           "phenoData|molecule|sample_type|TBdata_meta_char",
           "phenoData|organism|host_species|TBdata_clin_char",
         
           "phenoData|sample_code|xxxxx|TBdata_source",
           "phenoData|source_name|acc_source|TBdata_source",
           "phenoData|subject|xxxxx|TB_meta_char",
           "phenoData|time:|timepoints|TBdata_meta_char",
           "phenoData|timetonegativity|xxxxxx|TB_clin_char",
           "phenoData|tissue|organ|TBdata_clin_char",
           "phenoData|treatmentresult|xxxxxx|TBdata_clin_char",
           "phenoData|xpert|tb_diagnostic_test|TBdata_clin_char")) %>% 
  separate(x, into = c("dataset", "term", "sql_name", "sql_table"), sep = "\\|")
